...
package com.example.listdragtest.lib;

import in.srain.cube.views.ptr.RefreshView;
...
import com.example.listdragtest.R;
...
public class DragSortListView extends ListView {
	 ...
	 */
	/*
	 * public void setCanDrag(boolean flag) { if (mFloatViewManager != null) {
	 * if (DragSortController.DEBUG) { Log.d("DragSort", "setCanDrag=" + flag);
	 * } mFloatViewManager.setDragFlag(flag); } }
	 */
	...
	public interface FloatViewManager {
		 ...
		 * set refresh view
		 */
		public void setRefrshView(RefreshView refresh);
	...
	public void setRefreshView(RefreshView refresh) {
		if (mFloatViewManager != null) {
			mFloatViewManager.setRefrshView(refresh);
		}
	}
